...
| Cultural evolution and transmission-fidelity modelling | The accumulation threshold that Phase 12's fidelity criterion is measured against: improvements accumulate only when expected persistence per transmission exceeds one | Any specific published fidelity value |
