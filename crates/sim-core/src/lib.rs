...
pub use plasticity::{
    ...
    RULE_ELIGIBILITY_TRACE, RULE_HEBBIAN, RULE_MODULATED_HEBBIAN, RULE_OBSERVATIONAL, RULE_OJA,
    RULE_REGISTRY_VERSION, RULE_SPACE, RULE_STATIC, StepKind, StepOutcome, accumulate_clamped,
    decay_to_q16, decay_toward_zero, effective_weight, q16_to_f32, rule_in_registry,
    rule_is_modulated, step as plasticity_step, to_q16, to_q16_checked,
};
pub use registry::{
