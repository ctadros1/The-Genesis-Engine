...
pub use codec::{
    ...
    MAX_STORED_LEN, MAX_UNCOMPRESSED_LEN, SAVE_STATE_VERSION_3, SNAPSHOT_MAGIC, SnapshotInfo,
    crc32, decode_snapshot, decode_snapshot_format3, decode_snapshot_format4,
    decode_snapshot_format5, encode_snapshot, encode_snapshot_format3, encode_snapshot_format4,
    encode_snapshot_format5, peek_format_version, read_info,
};
pub use eventlog::{
