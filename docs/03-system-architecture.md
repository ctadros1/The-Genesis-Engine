...
| sim-analysis (Phase 17) | Offline similarity, era, and tradition detection over the event log and read-only views | A mutable world handle, an RNG stream, any path back into a rule |
