...
## Planned Successor: `lifesim-genome-v2` (Phase 7)
...
Phase 7 replaces it with a diploid chromosomal genome. The full design is
...
is slower and less directed than explicit add-node mutation, and Phase 7
measures the comparison (C7.5) rather than asserting an answer.
...
From Phase 8 the genome also encodes **how learning works**: which edges are
...
which would make the Phase 9 question unanswerable.
