...
Kept deliberately small in Phase 10. Each added layer is a new lineage and a
...
**Elevation is deliberately not mutable in Phase 10.** Elevation feeds
...
- Disabled-section equality: mutable world disabled reproduces the Phase 9
  fixture exactly.
