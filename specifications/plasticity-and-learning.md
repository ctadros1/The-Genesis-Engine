...
Status: design specification, not implemented. Phase 8. Policy version
...
Phase 9's transmission question is unaskable.
...
Rules 0 through 4 are available from Phase 8. **Rule 5 requires the Phase 9
...
`planning/phase-9-social-channel.md`: it authors the *capacity* for a
...
substantially more likely to make Phase 9 unfalsifiable. Phase 9's design
...
default, and it is the property that keeps Phase 9's question meaningful: if
...
Two obligations follow, and both are Phase 8 acceptance criteria:
...
- Asynchronous or double-buffered checkpointing (the deferred item behind
  D-019) is a Phase 5 prerequisite, not a Phase 8 discovery.
...
- Disabled-section equality: plasticity disabled reproduces the Phase 7
  fixture exactly.
