...
- Perception of the K nearest organisms: presence, distance, bearing, last
  committed action class, kinship, and a small set of visible phenotype
  values. All read from the previous tick's committed state.
