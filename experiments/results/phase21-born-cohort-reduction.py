        ...
        for seed in seeds:
            ...
            try:
                worlds[key] = {
                    ...
                    "matured_q": r.get("born_reached_maturity_by_food_quartile", "-"),
                    "reproduced_q": r.get("born_reproduced_by_food_quartile", "-"),
                    "matured_occ": r.get("born_reached_maturity_by_occupants", "-"),
                    "reproduced_occ": r.get("born_reproduced_by_occupants", "-"),
